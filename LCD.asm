#include p18f87k22.inc
    ...
    global  	LCD_Setup, LCD_delay_ms, LCD_Write_Hex
    global	LCD_Write_Message, LCD_init_message, LCD_SecondLine, LCD_TwoLine
    global  	myArray
    

acs5    	udata_acs   	; named variables in access ram
